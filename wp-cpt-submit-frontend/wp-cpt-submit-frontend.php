...
*Description: My plugin to explain the submit custom post type from frontend functionality. [book_frontend_post] 
*Version: 1.0
...
function book_frontend_post_func(){
	...
	$errors = 0;
	if(isset($_REQUEST['submit']) && wp_verify_nonce($_REQUEST['book_nonce'],'book_action_nonce')){
	...
	<div class="postbox">
		...
		<form method="post" enctype="multipart/form-data">
			<p><label for="title">Book Title *</label><br>
			   <input type="text" value="<?php echo !empty( $_REQUEST['title']) ? $_REQUEST['title'] : ''; ?>" name="title">
			</p>
			<p><label for="content">Book Content *</label><br>
       <textarea name="content" rows="6"><?php echo !empty( $_REQUEST['content']) ? $_REQUEST['content'] :  ''; ?>
